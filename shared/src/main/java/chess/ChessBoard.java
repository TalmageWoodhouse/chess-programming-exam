...
public class ChessBoard {
    ...
    public boolean isFriendly(ChessPosition myPos, ChessPosition pos) {
        ChessPiece myPiece = getPiece(myPos);
        ChessPiece targetPiece = getPiece(pos);
    ...
    public boolean isEnemy(ChessPosition myPos, ChessPosition pos) {
        ChessPiece myPiece = getPiece(myPos);
        ChessPiece targetPiece = getPiece(pos);
        if (myPiece == null || targetPiece == null) {
            return false;
